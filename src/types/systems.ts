...
declare global {
    ...
    interface Actor5e extends Omit<Actor, "system"> {
        system: {
    ...
    interface Item5e extends Omit<Item, "system" | "type"> {
        type: string;
        system: {
            activities?: {
    ...
    interface ActorPF extends Omit<Actor, "system"> {
        system: {
    ...
    interface ItemPF extends Omit<Item, "system"> {
        system: {
            equipped?: boolean;
            quantity?: number;
            spellbook?: string;
    ...
    interface ActorPF2e extends Omit<Actor, "system"> {
        saves?: {
    ...
    interface ItemPF2e extends Omit<Item, "system"> {
        system: {
            equipped?: {
                carryType?: string;
                handsHeld?: number;
